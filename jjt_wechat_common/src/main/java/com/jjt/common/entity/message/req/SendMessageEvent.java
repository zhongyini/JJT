...
public class SendMessageEvent extends  BaseEvent{
    ...
    public String toLog(){
    	...
    	sb.append("msgId:" + this.msgId + " ").append("status:" + this.status + " ");
    	sb.append("totalCount:" + this.totalCount + " ").append("filterCount:" + this.filterCount + " ");
    	sb.append("sentCount:" + this.sentCount + " ").append("errorCount:" + this.errorCount + " ");
    	return sb.toString();
    }
}
