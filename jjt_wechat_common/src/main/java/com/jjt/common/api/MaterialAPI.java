...
import com.jjt.common.api.enums.MaterialType;
import com.jjt.common.api.enums.ResultType;
import com.jjt.common.api.response.BaseResponse;
import com.jjt.common.api.response.DownloadMaterialResponse;
import com.jjt.common.api.response.GetMaterialListResponse;
import com.jjt.common.api.response.GetMaterialTotalCountResponse;
import com.jjt.common.api.response.UploadMaterialResponse;
...
//    }
    ...
    public DownloadMaterialResponse downloadMaterial(String mediaId, MaterialType type){
        ...
        String url = BASE_API_URL + "cgi-bin/material/get_material?access_token=" + accessToken;
     ...
     * @return 素材列表结果
     */
    public GetMaterialListResponse batchGetMaterialAll(MaterialType type, int offset, int count){
        if(offset < 0) offset = 0;
        //if(count > 20) count = 20;
        if(count < 1) count = 1;
