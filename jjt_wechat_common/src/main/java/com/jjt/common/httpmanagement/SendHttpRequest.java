...
import com.jjt.common.httpexception.HttpResponseNullException;
/**
 * 通过连接池发送Http请求
 * @author YUCJ
 *
...
public class SendHttpRequest {
	...
	public static String httpPostRequest(String requestUrl, String param) throws ClientProtocolException, IOException, HttpResponseNullException{
		CloseableHttpClient httpClient = HttpPoolConnManager.httpClientInstance();
		String result = null;
		StringEntity requestEntity = new StringEntity(param, ContentType.create("application/json", Charset.forName("UTF-8")));
