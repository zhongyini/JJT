...
public class SmsHelper {
	...
	// static final String accessKeyId = "LTAICENNcRslvkke";
	// static final String accessKeySecret = "TzI8HM7JcCGQy6PEmTAxfdJzi3Mwii";
	static final String accessKeyId = "LTAIwlYIAbzS5Xf0";
	static final String accessKeySecret = "l6lUd9028d465dzabS8l01C70ebe0Y";

	public static SendSmsResponse sendSms(String phoneNumber, String signName, String code) throws ClientException {
		...
		// 必填:短信模板-可在短信控制台中找到
//		request.setTemplateCode("SMS_137416497");
		request.setTemplateCode("SMS_167401170");
	...
	public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
		...
		// 必填-号码
		request.setPhoneNumber("13120770075");
		// 可选-流水号
	...
	public static void main(String[] args) throws ClientException, InterruptedException {
		...
		// 发短信
		SendSmsResponse response = sendSms("17756167663", "被鱼刺卡了的鱼", "521");
