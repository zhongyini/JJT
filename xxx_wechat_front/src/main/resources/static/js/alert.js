...
var showLoading=function (object) {
    ...
    try{
        ...
        if(mask==true){
            popToastHtml += `<div class="xsw_bei" style="position: fixed;width: 100%;height: 100%;top: 0;left: 0;background-color: #262626;opacity: 0.4;z-index: 999"></div>`
        }
        popToastHtml += `<div class="pop-toast" style="position: fixed;  width: 140px;  height: 140px;  text-align: center;background-color: #555;border-radius: 10px;box-shadow: 0 2px 8px #555 ;right: 50%;top: 50%;margin: -70px -70px 0 0;z-index: 999">`;
        popToastHtml += `<div id="xsw_canvas" style="140px;height: 60px;"></div>`;
        popToastHtml += ` <div class="toast-tip" style=" font-size: 16px;  color: #fff;  height: 45px;overflow: hidden;width:130px; word-wrap: break-word; text-align: center;padding: 0 5px ;margin-bottom: 10px;margin-top: 20px;">${tipTxt}</div>
                              </div></div>`;
        $("body").append(popToastHtml);
...
var showModal=function (object) {
    ...
    try{
        ...
        showModalHtml += `<div class="xsw_showModaBei" style="position: fixed;width: 100%;height: 100%;top: 0;left: 0; background-color: #333;opacity: 0.4;z-index: 999"></div>`
        showModalHtml+=`<div class="xsw_modal-data" style="width:220px;  border-radius: 10px;  top: 50%;  left: 50%;  box-shadow: 0 2px 8px #555 ;  background-color: #fff; padding:15px 0;  text-align:center;  z-index: 999;  position: fixed;">
        ...
        if(showCancel==false){
            showModalHtml+=         `<div style="position: absolute;bottom: 5px;"><div class="yesDian" style="width: 110px;display: inline-block;background-color: #b1a277;cursor: pointer;border-radius: 10px;padding: 8px 0;">${confirmText}</div></div>`
        }
        else{
            showModalHtml+=         ` <div style="position: absolute;bottom: 0px;"><div class="noDian" style="width: 110px;display: inline-block;margin-bottom: 0;background-color: #b1a277;cursor: pointer;border-radius: 0 0 0 10px;padding: 8px 0;color: #000000">${cancelText}</div><div class="yesDian" style="width: 110px;display: inline-block;background-color: #b1a277;cursor: pointer;border-radius: 0 0 10px 0;padding: 8px 0;">${confirmText}</div></div>`
        }
        `></div></div>`;
...
var showActionSheet = function (object) {
    ...
    try{
        ...
        showActionSheetHtml+=`<div class="xsw_showActionSheet" >
                                    <div class="xsw_showActionSheetBei" style="position: fixed;width: 100%;height: 100%;top: 0;left: 0; background-color: #333;opacity: 0.4;z-index: 999"></div>
                                    <div class="xsw_showActionSheet-data" style="width:220px;  border-radius: 5px;  top: 50%;  left: 50%;  box-shadow: 0 2px 8px #555 ;  background-color: #fff;  border:1px solid #000; text-align:center;  z-index: 999;  position: fixed;color: #000000">
